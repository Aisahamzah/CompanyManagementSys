...
if ((isset($_SESSION['user_position']) && $_SESSION['user_position'] != 'Admin')) {
...
$query_payroll = "SELECT COUNT(user_id) user_id FROM adminpayroll ";
  ...
  <div class="row">
    ...
    <div class="col-lg-3 col-6">
      ...
      <div class="small-box bg-danger">
        ...
        <a href="../payroll/PayrollAdmin.php" class="small-box-footer">papar info <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- ./col -->
    <div class="col-lg-3 col-6">
      ...
      <div class="small-box bg-danger">
        ...
        <a href="../leave/LeaveCheckForAdmin.php" class="small-box-footer">papar info <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
  </div>
  <!-- /.row -->
