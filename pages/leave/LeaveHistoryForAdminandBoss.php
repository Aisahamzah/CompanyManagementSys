		 ...
		 <div class="card">
		  <div class="card-primary">
            <div class="card-header">
              <h3 class="card-title">SENARAI CUTI PEKERJA TERDAHULU</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				join user u
				on h.user_id=u.user_id where leave_status='LULUS' OR leave_status='TIDAK LULUS' OR leave_status='DALAM PROSES' " ;	
				$count=0;
		...
		?>
                <tr>
                 <td class="text-center" ><?php echo $count; ?></td>
                  ...
                  <td width="170px;"><?php echo $from ?> - <?php echo$until ?></td>
