 ...
 {  
		...
		$output .= '	
						<div class="modal-footer">
							<button type="submit" name="xlulus" class="bg-danger btn float-right">DITOLAK</button>
							<button type="submit" name="lulus" class="bg-success btn float-right">DIBAYAR</button>
						</div>
