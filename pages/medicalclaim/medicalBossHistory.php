...
include "../header/header.php";
		...
		if(isset($_POST['lulus'])){
			...
			$med_stA= $_REQUEST['checkbox'];
			$b=implode(",",$med_stA);
			
			$sql2 = "UPDATE medical SET med_status = 'PAID' WHERE med_id in ($b)";
			$result2=mysqli_query($conn,$sql2) or die("Query failed"); 
			$sql3 = "UPDATE medical SET med_check = 'checked' WHERE med_id in ($b)";
			$result3=mysqli_query($conn,$sql3) or die("Query failed");
			
		}
		
		if(isset($_POST['xlulus'])){
			
			$med_stX= $_REQUEST['checkbox'];
			$c=implode(",",$med_stX);
			
			$sql3 = "UPDATE medical SET med_status = 'REJECT' where med_id in ($c)";
			$result3=mysqli_query($conn,$sql3) or die("Query failed");
			$sql4 = "UPDATE medical SET med_check = 'checked' WHERE med_id in ($c)";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>PERMOHONAN TUNTUTAN PERUBATAN</h1>
          </div>
          <div class="col-sm-6">
...
<!--TUTUP TAJUKK BESAR -->
	...
	<section class="content">
      <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <div class="card-body">
				<form action="medicalBossHistory.php" method = "post" >
