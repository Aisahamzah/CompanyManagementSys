...
{    
   ...
   // $userid= $_POST['user_id'];
	...
	else
	{
		...
		window.location.href='TESTING.php?id='".$staffid."''
		</SCRIPT>");
		exit();	
	}
...
/* if ($result){ 
		...
		echo ("<SCRIPT LANGUAGE='JavaScript'>
		window.alert('Update unsuccessfully!')
...
<form  action="TESTING.php" method="post" role="form" 
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" name="ic" id="ic" class="form-control" value= "<?php echo $row1 ['user_ic']; ?>"/>
						</div>
					</div>
					...
					<div class="col-md-6">	  
						<div class="form-group">
							...
							<input type="text" name="telNum" id="telNum" class="form-control" value= "<?php echo $row1 ['user_phoneNum']; ?>"/>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" name="eRelationship" id="eRalationship" class="form-control" value= "<?php echo $row1 ['user_eContactRelationship']; ?>"/>
						</div>
					</div>
					...
					<div class="col-md-6">				  
						<div class="form-group">
							...
							<input type="text" class="form-control" name="eNum" id="eNum" value= "<?php echo $row1 ['user_eContactNum']; ?>"/>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="col-md-5">
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" name="cPay" id="cPay" class="form-control" value= "<?php echo $row1 ['salary']; ?>"/>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" name="staffid" id="staffid" class="form-control" value= "<?php echo $row1 ['user_id']; ?>"/>
						</div>
					</div>
					...
					<div class="col-md-6">				  
						<div class="form-group">
							...
							<input type="password" class="form-control" name="password" id="exampleInputPassword1" value= "<?php echo $row1 ['user_password']; ?>"/>
						</div>
					</div>
				</div>
			</div>
...
<?php } ?>
		...
		<div align="right" class="col-12">
			<button name="update" type="submit" class="btn btn-success">KEMASKINI</button>
		</div>
